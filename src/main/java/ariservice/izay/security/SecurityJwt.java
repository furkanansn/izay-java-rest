...
public class SecurityJwt {
    ...
    public SecurityJwt(JSONObject payload) {
        this(payload.getString("sub"), payload.getJSONArray("aud"), payload.getLong("exp"));
    }

    public SecurityJwt(String sub, JSONArray aud, long expires) {
        this();
        payload.put("sub", sub);
        payload.put("aud", aud);
     ...
     */
    public SecurityJwt(String token) throws NoSuchAlgorithmException {
        this();
    ...
    private String hmacSha256(String data, String secret) {
        try {
            ...
            Logger.getLogger(SecurityJwt.class.getName()).log(Level.SEVERE, ex.getMessage(), ex);
            return null;
        }
    }
